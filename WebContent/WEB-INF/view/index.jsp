...
<body>
    ...
    <main>
        <div class="container bg-light-pink py-2">
            <div class="row pt-4">
       ...
       <div class="container bg-light-pink py-2">
            <div class="row pt-4">
                <div class="main-img-box col-lg-4 mb-4">
                    ...
                    <div class="main-tag-img center-block">
                        <img src="images/chanese_food.jpg" alt="中華の画像" class="img-fluid center-block">
                    </div>
                </div>
                <div class="main-menu-box col-lg-8">
                    <div class="row mb-2">
        ...
        <div class="container bg-light-pink py-2">
            <div class="row pt-4">
                <div class="main-img-box col-lg-4 mb-4">
                    ...
                    <div class="main-tag-img center-block">
                        <img src="images/western_food.jpg" alt="洋食の画像" class="img-fluid center-block">
                    </div>
                </div>
                <div class="main-menu-box col-lg-8">
                    <div class="row mb-2">
